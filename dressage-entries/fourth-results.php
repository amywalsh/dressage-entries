<?php
	...
	<table id="table-wrap" style="width:100%;" border="1">
		...
		$open_fourth_sql = "SELECT riders.FirstName, riders.LastName, horses.Name, classes.ID, tests.name FROM  ( ( ( entries INNER JOIN riders on entries.riderID = riders.ID ) INNER JOIN horses ON entries.HorseID = horses.ID ) INNER JOIN classes ON entries.ID = classes.EntryID ) INNER JOIN tests ON classes.TestID = tests.ID WHERE entries.ShowID = 6 AND entries.Status <> 'Scratch' AND tests.ID = 16 AND riders.Level = 'Open'";
		...
		if(mysqli_num_rows( $open_fourth_res ) > 0 ) {
			...
			<table style="width:100%;" border="1">
				<tbody>
					<tr>
						<th colspan="4" bgcolor="#75CCE0" style="text-align: center;"><strong><span class="list-title">2015 USEF Fourth Level Test 1</span></strong></th>
					</tr>
				</tbody>
			</table>
			<table style="width:100%;" border="1">
		...
		$open_fourth_sql = "SELECT riders.FirstName, riders.LastName, horses.Name, classes.ID, tests.name FROM  
			...
			AND entries.Status <> 'Scratch' AND tests.ID = 17 AND riders.Level = 'Open'";
		$open_fourth_res = mysqli_query( $mysqli, $open_fourth_sql ) or die(mysqli_error( $mysqli ) );
		...
		if(mysqli_num_rows( $open_fourth_res ) > 0 ) {
			...
			<table style="width:100%;" border="1">
				<tbody>
					<tr>
						<th colspan="4" bgcolor="#75CCE0" style="text-align: center;"><strong><span class="list-title">2015 USEF Fourth Level Test 2</span></strong></th>
					</tr>
				</tbody>
			</table>
			<table style="width:100%;" border="1">
		...
		$open_fourth_sql = "SELECT riders.FirstName, riders.LastName, horses.Name, classes.ID, tests.name FROM  
			( ( ( entries INNER JOIN riders on entries.riderID = riders.ID ) 
			INNER JOIN horses ON entries.HorseID = horses.ID ) INNER JOIN classes ON entries.ID = classes.EntryID ) 
			INNER JOIN tests ON classes.TestID = tests.ID WHERE entries.ShowID = 6 AND entries.Status <> 'Scratch' AND tests.ID = 18 AND riders.Level = 'Open'";
		$open_fourth_res = mysqli_query( $mysqli, $open_fourth_sql ) or die(mysqli_error( $mysqli ) );
		...
		if(mysqli_num_rows( $open_fourth_res ) > 0 ) {
			...
			?>
				...
				<tbody>
					<tr>
						<th colspan="4" bgcolor="#75CCE0" style="text-align: center;"><strong><span class="list-title">2015 USEF Fourth Level Test 3</span></strong></th>
					</tr>
				</tbody>
			</table>
			<table style="width:100%;" border="1">
...
<?php
	...
	<table id="table-wrap" style="width:100%;" border="1">
		...
		$open_fourth_sql = "SELECT riders.FirstName, riders.LastName, horses.Name, classes.ID, tests.name 
			...
			WHERE entries.ShowID = 6 AND entries.Status <> 'Scratch' AND tests.ID = 16 AND riders.Level = 'Amateur'";
		$open_fourth_res = mysqli_query( $mysqli, $open_fourth_sql ) or die(mysqli_error( $mysqli ) );
		...
		$open_fourth_sql = "SELECT riders.FirstName, riders.LastName, horses.Name, classes.ID, tests.name FROM  
			( ( ( entries INNER JOIN riders on entries.riderID = riders.ID ) 
			INNER JOIN horses ON entries.HorseID = horses.ID ) INNER JOIN classes ON entries.ID = classes.EntryID ) 
			INNER JOIN tests ON classes.TestID = tests.ID WHERE entries.ShowID = 6 AND entries.Status <> 'Scratch' AND tests.ID = 17 AND riders.Level = 'Amateur'";
		$open_fourth_res = mysqli_query( $mysqli, $open_fourth_sql ) or die(mysqli_error( $mysqli ) );
		...
		$open_fourth_sql = "SELECT riders.FirstName, riders.LastName, horses.Name, classes.ID, tests.name FROM  
			( ( ( entries INNER JOIN riders on entries.riderID = riders.ID ) 
			INNER JOIN horses ON entries.HorseID = horses.ID ) INNER JOIN classes ON entries.ID = classes.EntryID ) 
			INNER JOIN tests ON classes.TestID = tests.ID WHERE entries.ShowID = 6 AND entries.Status <> 'Scratch' AND tests.ID = 18 AND riders.Level = 'Amateur'";
		$open_fourth_res = mysqli_query( $mysqli, $open_fourth_sql ) or die(mysqli_error( $mysqli ) );
...
<?php
	...
	<table id="table-wrap" style="width:100%;" border="1">
		...
		$open_fourth_sql = "SELECT riders.FirstName, riders.LastName, horses.Name, classes.ID, tests.name 
			FROM  ( ( ( entries INNER JOIN riders on entries.riderID = riders.ID ) INNER JOIN horses ON entries.HorseID = horses.ID ) 
			INNER JOIN classes ON entries.ID = classes.EntryID ) INNER JOIN tests ON classes.TestID = tests.ID 
			WHERE entries.ShowID = 6 AND entries.Status <> 'Scratch' AND tests.ID = 16 AND riders.Level = 'Junior'";
		$open_fourth_res = mysqli_query( $mysqli, $open_fourth_sql ) or die(mysqli_error( $mysqli ) );
		...
		$open_fourth_sql = "SELECT riders.FirstName, riders.LastName, horses.Name, classes.ID, tests.name FROM  
			( ( ( entries INNER JOIN riders on entries.riderID = riders.ID ) 
			INNER JOIN horses ON entries.HorseID = horses.ID ) INNER JOIN classes ON entries.ID = classes.EntryID ) 
			INNER JOIN tests ON classes.TestID = tests.ID WHERE entries.ShowID = 6 AND entries.Status <> 'Scratch' AND tests.ID = 17 AND riders.Level = 'Junior'";
		$open_fourth_res = mysqli_query( $mysqli, $open_fourth_sql ) or die(mysqli_error( $mysqli ) );
		...
		$open_fourth_sql = "SELECT riders.FirstName, riders.LastName, horses.Name, classes.ID, tests.name FROM  
			( ( ( entries INNER JOIN riders on entries.riderID = riders.ID ) 
			INNER JOIN horses ON entries.HorseID = horses.ID ) INNER JOIN classes ON entries.ID = classes.EntryID ) 
			INNER JOIN tests ON classes.TestID = tests.ID WHERE entries.ShowID = 6 AND entries.Status <> 'Scratch' AND tests.ID = 18 AND riders.Level = 'Junior'";
		$open_fourth_res = mysqli_query( $mysqli, $open_fourth_sql ) or die(mysqli_error( $mysqli ) );
