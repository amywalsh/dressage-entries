...
//Fourth Level Open Results
		$fourth_entries_sql = "SELECT entries.ID, riders.ID, classes.ID, tests.ID 
				...
				ON tests.ID = classes.TestID WHERE tests.ID IN (16, 17, 18) AND entries.ShowID = 4 AND riders.Level = 'Open'";
		...
		$open_fourth_sql = "SELECT riders.FirstName, riders.LastName, horses.Name, TestScores.PercentageScore 
							...
							INNER JOIN TestScores ON classes.ID = TestScores.ClassID WHERE entries.ShowID = 4 AND classes.TestID = 16 
		...
		$open_fourth_sql = "SELECT riders.FirstName, riders.LastName, horses.Name, TestScores.PercentageScore 
							FROM ( ( ( entries INNER JOIN riders ON entries.riderID = riders.ID ) 
							INNER JOIN horses ON entries.HorseID = horses.ID ) INNER JOIN classes on entries.ID = classes.EntryID ) 
							INNER JOIN TestScores ON classes.ID = TestScores.ClassID WHERE entries.ShowID = 4 AND classes.TestID = 17 
							AND riders.Level = 'Open' ORDER BY TestScores.PercentageScore DESC";
		$open_fourth_res = mysqli_query( $mysqli, $open_fourth_sql ) or die(mysqli_error( $mysqli ) );
...
//Fourth Test 3 Open
		$open_fourth_sql = "SELECT riders.FirstName, riders.LastName, horses.Name, TestScores.PercentageScore 
							FROM ( ( ( entries INNER JOIN riders ON entries.riderID = riders.ID ) 
							INNER JOIN horses ON entries.HorseID = horses.ID ) INNER JOIN classes on entries.ID = classes.EntryID ) 
							INNER JOIN TestScores ON classes.ID = TestScores.ClassID WHERE entries.ShowID = 4 AND classes.TestID = 18 
							AND riders.Level = 'Open' ORDER BY TestScores.PercentageScore DESC";
		$open_fourth_res = mysqli_query( $mysqli, $open_fourth_sql ) or die(mysqli_error( $mysqli ) );
...
//Fourth Level Amateur Results
		$fourth_entries_sql = "SELECT entries.ID, riders.ID, classes.ID, tests.ID 
				FROM ( ( entries INNER JOIN riders ON riders.ID = entries.RiderID ) 
				INNER JOIN classes ON classes.EntryID = entries.ID ) INNER JOIN tests 
				ON tests.ID = classes.TestID WHERE tests.ID IN (16, 17, 18) AND entries.ShowID = 4 AND riders.Level = 'Amateur'";
		$fourth_entries_res = mysqli_query( $mysqli, $fourth_entries_sql ) or die(mysqli_error( $mysqli ) );
...
//Fourth Level junior Results
		$fourth_entries_sql = "SELECT entries.ID, riders.ID, classes.ID, tests.ID 
				FROM ( ( entries INNER JOIN riders ON riders.ID = entries.RiderID ) 
				INNER JOIN classes ON classes.EntryID = entries.ID ) INNER JOIN tests 
				ON tests.ID = classes.TestID WHERE tests.ID IN (16, 17, 18) AND entries.ShowID = 4 AND riders.Level = 'Junior'";
		$fourth_entries_res = mysqli_query( $mysqli, $fourth_entries_sql ) or die(mysqli_error( $mysqli ) );
...
//Third Level Open Results
		$third_entries_sql = "SELECT entries.ID, riders.ID, classes.ID, tests.ID 
				FROM ( ( entries INNER JOIN riders ON riders.ID = entries.RiderID ) 
				INNER JOIN classes ON classes.EntryID = entries.ID ) INNER JOIN tests 
				ON tests.ID = classes.TestID WHERE tests.ID IN (15, 14, 13) AND entries.ShowID = 4 AND riders.Level = 'Open'";
		...
		$open_third_sql = "SELECT riders.FirstName, riders.LastName, horses.Name, TestScores.PercentageScore 
							FROM ( ( ( entries INNER JOIN riders ON entries.riderID = riders.ID ) 
							INNER JOIN horses ON entries.HorseID = horses.ID ) INNER JOIN classes on entries.ID = classes.EntryID ) 
							INNER JOIN TestScores ON classes.ID = TestScores.ClassID WHERE entries.ShowID = 4 AND classes.TestID = 13 
							AND riders.Level = 'Open' ORDER BY TestScores.PercentageScore DESC";
		...
		$open_third_sql = "SELECT riders.FirstName, riders.LastName, horses.Name, TestScores.PercentageScore 
							FROM ( ( ( entries INNER JOIN riders ON entries.riderID = riders.ID ) 
							INNER JOIN horses ON entries.HorseID = horses.ID ) INNER JOIN classes on entries.ID = classes.EntryID ) 
							INNER JOIN TestScores ON classes.ID = TestScores.ClassID WHERE entries.ShowID = 4 AND classes.TestID = 14 
							AND riders.Level = 'Open' ORDER BY TestScores.PercentageScore DESC";
		$open_third_res = mysqli_query( $mysqli, $open_third_sql ) or die(mysqli_error( $mysqli ) );
...
//Third Test 3 Open
		$open_third_sql = "SELECT riders.FirstName, riders.LastName, horses.Name, TestScores.PercentageScore 
							FROM ( ( ( entries INNER JOIN riders ON entries.riderID = riders.ID ) 
							INNER JOIN horses ON entries.HorseID = horses.ID ) INNER JOIN classes on entries.ID = classes.EntryID ) 
							INNER JOIN TestScores ON classes.ID = TestScores.ClassID WHERE entries.ShowID = 4 AND classes.TestID = 15 
							AND riders.Level = 'Open' ORDER BY TestScores.PercentageScore DESC";
		$open_third_res = mysqli_query( $mysqli, $open_third_sql ) or die(mysqli_error( $mysqli ) );
		...
		$third_champs_sql = "SELECT classes.EntryID, riders.FirstName, riders.LastName, horses.Name, AVG(TestScores.PercentageScore) FROM ( ( ( entries INNER JOIN riders ON entries.riderID = riders.ID ) INNER JOIN horses ON entries.HorseID = horses.ID ) INNER JOIN classes on entries.ID = classes.EntryID ) INNER JOIN TestScores ON classes.ID = TestScores.ClassID WHERE classes.TestID = ANY ( SELECT ID from tests WHERE tests.ID IN (13, 14, 15) ) AND entries.ShowID = 4 AND riders.FirstName <> 'test' AND riders.Level = 'Open' GROUP BY classes.EntryID HAVING COUNT(classes.TestID) > 1 ORDER BY AVG(TestScores.PercentageScore) DESC LIMIT 2";
...
//Third Level Amateur Results
		$third_entries_sql = "SELECT entries.ID, riders.ID, classes.ID, tests.ID 
				FROM ( ( entries INNER JOIN riders ON riders.ID = entries.RiderID ) 
				INNER JOIN classes ON classes.EntryID = entries.ID ) INNER JOIN tests 
				ON tests.ID = classes.TestID WHERE tests.ID IN (15, 14, 13) AND entries.ShowID = 4 AND riders.Level = 'Amateur'";
		$third_entries_res = mysqli_query( $mysqli, $third_entries_sql ) or die(mysqli_error( $mysqli ) );
...
//Third Level junior Results
		$third_entries_sql = "SELECT entries.ID, riders.ID, classes.ID, tests.ID 
				FROM ( ( entries INNER JOIN riders ON riders.ID = entries.RiderID ) 
				INNER JOIN classes ON classes.EntryID = entries.ID ) INNER JOIN tests 
				ON tests.ID = classes.TestID WHERE tests.ID IN (15, 14, 13) AND entries.ShowID = 4 AND riders.Level = 'Junior'";
		$third_entries_res = mysqli_query( $mysqli, $third_entries_sql ) or die(mysqli_error( $mysqli ) );
...
//Second Level Open Results
		$second_entries_sql = "SELECT entries.ID, riders.ID, classes.ID, tests.ID 
				FROM ( ( entries INNER JOIN riders ON riders.ID = entries.RiderID ) 
				INNER JOIN classes ON classes.EntryID = entries.ID ) INNER JOIN tests 
				ON tests.ID = classes.TestID WHERE tests.ID IN (10, 11, 12) AND entries.ShowID = 4 AND riders.Level = 'Open'";
		...
		$open_second_sql = "SELECT riders.FirstName, riders.LastName, horses.Name, TestScores.PercentageScore 
							FROM ( ( ( entries INNER JOIN riders ON entries.riderID = riders.ID ) 
							INNER JOIN horses ON entries.HorseID = horses.ID ) INNER JOIN classes on entries.ID = classes.EntryID ) 
							INNER JOIN TestScores ON classes.ID = TestScores.ClassID WHERE entries.ShowID = 4 AND classes.TestID = 10 
							AND riders.Level = 'Open' ORDER BY TestScores.PercentageScore DESC";
		...
		$open_second_sql = "SELECT riders.FirstName, riders.LastName, horses.Name, TestScores.PercentageScore 
							FROM ( ( ( entries INNER JOIN riders ON entries.riderID = riders.ID ) 
							INNER JOIN horses ON entries.HorseID = horses.ID ) INNER JOIN classes on entries.ID = classes.EntryID ) 
							INNER JOIN TestScores ON classes.ID = TestScores.ClassID WHERE entries.ShowID = 4 AND classes.TestID = 11 
							AND riders.Level = 'Open' ORDER BY TestScores.PercentageScore DESC";
		$open_second_res = mysqli_query( $mysqli, $open_second_sql ) or die(mysqli_error( $mysqli ) );
...
//Second Test 3 Open
		$open_second_sql = "SELECT riders.FirstName, riders.LastName, horses.Name, TestScores.PercentageScore 
							FROM ( ( ( entries INNER JOIN riders ON entries.riderID = riders.ID ) 
							INNER JOIN horses ON entries.HorseID = horses.ID ) INNER JOIN classes on entries.ID = classes.EntryID ) 
							INNER JOIN TestScores ON classes.ID = TestScores.ClassID WHERE entries.ShowID = 4 AND classes.TestID = 12 
							AND riders.Level = 'Open' ORDER BY TestScores.PercentageScore DESC";
		$open_second_res = mysqli_query( $mysqli, $open_second_sql ) or die(mysqli_error( $mysqli ) );
		...
		$second_champs_sql = "SELECT classes.EntryID, riders.FirstName, riders.LastName, horses.Name, AVG(TestScores.PercentageScore) FROM ( ( ( entries INNER JOIN riders ON entries.riderID = riders.ID ) INNER JOIN horses ON entries.HorseID = horses.ID ) INNER JOIN classes on entries.ID = classes.EntryID ) INNER JOIN TestScores ON classes.ID = TestScores.ClassID WHERE classes.TestID = ANY ( SELECT ID from tests WHERE tests.ID IN (10, 11, 12) ) AND entries.ShowID = 4 AND riders.FirstName <> 'test' AND riders.Level = 'Open' GROUP BY classes.EntryID HAVING COUNT(classes.TestID) > 1 ORDER BY AVG(TestScores.PercentageScore) DESC LIMIT 2";
...
//Second Level Amateur Results
		$second_entries_sql = "SELECT entries.ID, riders.ID, classes.ID, tests.ID 
				FROM ( ( entries INNER JOIN riders ON riders.ID = entries.RiderID ) 
				INNER JOIN classes ON classes.EntryID = entries.ID ) INNER JOIN tests 
				ON tests.ID = classes.TestID WHERE tests.ID IN (10, 11, 12) AND entries.ShowID = 4 AND riders.Level = 'Amateur'";
		$second_entries_res = mysqli_query( $mysqli, $second_entries_sql ) or die(mysqli_error( $mysqli ) );
...
//Second Level junior Results
		$second_entries_sql = "SELECT entries.ID, riders.ID, classes.ID, tests.ID 
				FROM ( ( entries INNER JOIN riders ON riders.ID = entries.RiderID ) 
				INNER JOIN classes ON classes.EntryID = entries.ID ) INNER JOIN tests 
				ON tests.ID = classes.TestID WHERE tests.ID IN (10, 11, 12) AND entries.ShowID = 4 AND riders.Level = 'Junior'";
		$second_entries_res = mysqli_query( $mysqli, $second_entries_sql ) or die(mysqli_error( $mysqli ) );
...
//First Level Open Results
		$first_entries_sql = "SELECT entries.ID, riders.ID, classes.ID, tests.ID 
				FROM ( ( entries INNER JOIN riders ON riders.ID = entries.RiderID ) 
				INNER JOIN classes ON classes.EntryID = entries.ID ) INNER JOIN tests 
				ON tests.ID = classes.TestID WHERE tests.ID IN (7, 8, 9) AND entries.ShowID = 4 AND riders.Level = 'Open'";
		...
		$open_first_sql = "SELECT riders.FirstName, riders.LastName, horses.Name, TestScores.PercentageScore 
							FROM ( ( ( entries INNER JOIN riders ON entries.riderID = riders.ID ) 
							INNER JOIN horses ON entries.HorseID = horses.ID ) INNER JOIN classes on entries.ID = classes.EntryID ) 
							INNER JOIN TestScores ON classes.ID = TestScores.ClassID WHERE entries.ShowID = 4 AND classes.TestID = 7 
							AND riders.Level = 'Open' ORDER BY TestScores.PercentageScore DESC";
		...
		$open_first_sql = "SELECT riders.FirstName, riders.LastName, horses.Name, TestScores.PercentageScore 
							FROM ( ( ( entries INNER JOIN riders ON entries.riderID = riders.ID ) 
							INNER JOIN horses ON entries.HorseID = horses.ID ) INNER JOIN classes on entries.ID = classes.EntryID ) 
							INNER JOIN TestScores ON classes.ID = TestScores.ClassID WHERE entries.ShowID = 4 AND classes.TestID = 8 
							AND riders.Level = 'Open' ORDER BY TestScores.PercentageScore DESC";
		$open_first_res = mysqli_query( $mysqli, $open_first_sql ) or die(mysqli_error( $mysqli ) );
...
//First Test 3 Open
		$open_first_sql = "SELECT riders.FirstName, riders.LastName, horses.Name, TestScores.PercentageScore 
							FROM ( ( ( entries INNER JOIN riders ON entries.riderID = riders.ID ) 
							INNER JOIN horses ON entries.HorseID = horses.ID ) INNER JOIN classes on entries.ID = classes.EntryID ) 
							INNER JOIN TestScores ON classes.ID = TestScores.ClassID WHERE entries.ShowID = 4 AND classes.TestID = 9 
							AND riders.Level = 'Open' ORDER BY TestScores.PercentageScore DESC";
		$open_first_res = mysqli_query( $mysqli, $open_first_sql ) or die(mysqli_error( $mysqli ) );
		...
		$first_champs_sql = "SELECT classes.EntryID, riders.FirstName, riders.LastName, horses.Name, AVG(TestScores.PercentageScore) FROM ( ( ( entries INNER JOIN riders ON entries.riderID = riders.ID ) INNER JOIN horses ON entries.HorseID = horses.ID ) INNER JOIN classes on entries.ID = classes.EntryID ) INNER JOIN TestScores ON classes.ID = TestScores.ClassID WHERE classes.TestID = ANY ( SELECT ID from tests WHERE tests.ID IN (7, 8, 9) ) AND entries.ShowID = 4 AND riders.FirstName <> 'test' AND riders.Level = 'Open' GROUP BY classes.EntryID HAVING COUNT(classes.TestID) > 1 ORDER BY AVG(TestScores.PercentageScore) DESC LIMIT 2";
...
//First Level Amateur Results
		$first_entries_sql = "SELECT entries.ID, riders.ID, classes.ID, tests.ID 
				FROM ( ( entries INNER JOIN riders ON riders.ID = entries.RiderID ) 
				INNER JOIN classes ON classes.EntryID = entries.ID ) INNER JOIN tests 
				ON tests.ID = classes.TestID WHERE tests.ID IN (7, 8, 9) AND entries.ShowID = 4 AND riders.Level = 'Amateur'";
		$first_entries_res = mysqli_query( $mysqli, $first_entries_sql ) or die(mysqli_error( $mysqli ) );
...
//First Level junior Results
		$first_entries_sql = "SELECT entries.ID, riders.ID, classes.ID, tests.ID 
				FROM ( ( entries INNER JOIN riders ON riders.ID = entries.RiderID ) 
				INNER JOIN classes ON classes.EntryID = entries.ID ) INNER JOIN tests 
				ON tests.ID = classes.TestID WHERE tests.ID IN (7, 8, 9) AND entries.ShowID = 4 AND riders.Level = 'Junior'";
		$first_entries_res = mysqli_query( $mysqli, $first_entries_sql ) or die(mysqli_error( $mysqli ) );
...
//Training Level Open Results
		$training_entries_sql = "SELECT entries.ID, riders.ID, classes.ID, tests.ID 
				FROM ( ( entries INNER JOIN riders ON riders.ID = entries.RiderID ) 
				INNER JOIN classes ON classes.EntryID = entries.ID ) INNER JOIN tests 
				ON tests.ID = classes.TestID WHERE tests.ID IN (4, 5, 6) AND entries.ShowID = 4 AND entries.Status <> 'Scratch' AND riders.Level = 'Open'";
		...
		$open_training_sql = "SELECT riders.FirstName, riders.LastName, horses.Name, TestScores.PercentageScore 
							FROM ( ( ( entries INNER JOIN riders ON entries.riderID = riders.ID ) 
							INNER JOIN horses ON entries.HorseID = horses.ID ) INNER JOIN classes on entries.ID = classes.EntryID ) 
							INNER JOIN TestScores ON classes.ID = TestScores.ClassID WHERE entries.ShowID = 4 AND classes.TestID = 4 
							AND riders.Level = 'Open' ORDER BY TestScores.PercentageScore DESC";
		...
		$open_training_sql = "SELECT riders.FirstName, riders.LastName, horses.Name, TestScores.PercentageScore 
							FROM ( ( ( entries INNER JOIN riders ON entries.riderID = riders.ID ) 
							INNER JOIN horses ON entries.HorseID = horses.ID ) INNER JOIN classes on entries.ID = classes.EntryID ) 
							INNER JOIN TestScores ON classes.ID = TestScores.ClassID WHERE entries.ShowID = 4 AND classes.TestID = 5 
							AND riders.Level = 'Open' ORDER BY TestScores.PercentageScore DESC";
		$open_training_res = mysqli_query( $mysqli, $open_training_sql ) or die(mysqli_error( $mysqli ) );
...
//Training Test 3 Open
		$open_training_sql = "SELECT riders.FirstName, riders.LastName, horses.Name, TestScores.PercentageScore 
							FROM ( ( ( entries INNER JOIN riders ON entries.riderID = riders.ID ) 
							INNER JOIN horses ON entries.HorseID = horses.ID ) INNER JOIN classes on entries.ID = classes.EntryID ) 
							INNER JOIN TestScores ON classes.ID = TestScores.ClassID WHERE entries.ShowID = 4 AND classes.TestID = 6 
							AND riders.Level = 'Open' ORDER BY TestScores.PercentageScore DESC";
		$open_training_res = mysqli_query( $mysqli, $open_training_sql ) or die(mysqli_error( $mysqli ) );
...
//Training Level Amateur Results
		$training_entries_sql = "SELECT entries.ID, riders.ID, classes.ID, tests.ID 
				FROM ( ( entries INNER JOIN riders ON riders.ID = entries.RiderID ) 
				INNER JOIN classes ON classes.EntryID = entries.ID ) INNER JOIN tests 
				ON tests.ID = classes.TestID WHERE tests.ID IN (4, 5, 6) AND entries.ShowID = 4 AND riders.Level = 'Amateur'";
		$training_entries_res = mysqli_query( $mysqli, $training_entries_sql ) or die(mysqli_error( $mysqli ) );
...
//Training Level junior Results
		$training_entries_sql = "SELECT entries.ID, riders.ID, classes.ID, tests.ID 
				FROM ( ( entries INNER JOIN riders ON riders.ID = entries.RiderID ) 
				INNER JOIN classes ON classes.EntryID = entries.ID ) INNER JOIN tests 
				ON tests.ID = classes.TestID WHERE tests.ID IN (4, 5, 6) AND entries.ShowID = 4 AND riders.Level = 'Junior'";
		$training_entries_res = mysqli_query( $mysqli, $training_entries_sql ) or die(mysqli_error( $mysqli ) );
...
//Introductory Level Open Results
		$intro_entries_sql = "SELECT entries.ID, riders.ID, classes.ID, tests.ID 
				FROM ( ( entries INNER JOIN riders ON riders.ID = entries.RiderID ) 
				INNER JOIN classes ON classes.EntryID = entries.ID ) INNER JOIN tests 
				ON tests.ID = classes.TestID WHERE tests.ID IN (1, 2, 3) AND entries.ShowID = 4 AND riders.Level = 'Open'";
		...
		$open_intro_sql = "SELECT riders.FirstName, riders.LastName, horses.Name, TestScores.PercentageScore 
							FROM ( ( ( entries INNER JOIN riders ON entries.riderID = riders.ID ) 
							INNER JOIN horses ON entries.HorseID = horses.ID ) INNER JOIN classes on entries.ID = classes.EntryID ) 
							INNER JOIN TestScores ON classes.ID = TestScores.ClassID WHERE entries.ShowID = 4 AND classes.TestID = 1 
							AND riders.Level = 'Open' ORDER BY TestScores.PercentageScore DESC";
		...
		$open_intro_sql = "SELECT riders.FirstName, riders.LastName, horses.Name, TestScores.PercentageScore 
							FROM ( ( ( entries INNER JOIN riders ON entries.riderID = riders.ID ) 
							INNER JOIN horses ON entries.HorseID = horses.ID ) INNER JOIN classes on entries.ID = classes.EntryID ) 
							INNER JOIN TestScores ON classes.ID = TestScores.ClassID WHERE entries.ShowID = 4 AND classes.TestID = 2 
							AND riders.Level = 'Open' ORDER BY TestScores.PercentageScore DESC";
		$open_intro_res = mysqli_query( $mysqli, $open_intro_sql ) or die(mysqli_error( $mysqli ) );
...
//Introductory Test 3 Open
		$open_intro_sql = "SELECT riders.FirstName, riders.LastName, horses.Name, TestScores.PercentageScore 
							FROM ( ( ( entries INNER JOIN riders ON entries.riderID = riders.ID ) 
							INNER JOIN horses ON entries.HorseID = horses.ID ) INNER JOIN classes on entries.ID = classes.EntryID ) 
							INNER JOIN TestScores ON classes.ID = TestScores.ClassID WHERE entries.ShowID = 4 AND classes.TestID = 3 
							AND riders.Level = 'Open' ORDER BY TestScores.PercentageScore DESC";
		$open_intro_res = mysqli_query( $mysqli, $open_intro_sql ) or die(mysqli_error( $mysqli ) );
		...
		$intro_champs_sql = "SELECT classes.EntryID, riders.FirstName, riders.LastName, horses.Name, AVG(TestScores.PercentageScore) FROM ( ( ( entries INNER JOIN riders ON entries.riderID = riders.ID ) INNER JOIN horses ON entries.HorseID = horses.ID ) INNER JOIN classes on entries.ID = classes.EntryID ) INNER JOIN TestScores ON classes.ID = TestScores.ClassID WHERE classes.TestID = ANY ( SELECT ID from tests WHERE tests.ID IN (1, 2, 3) ) AND entries.ShowID = 4 AND riders.FirstName <> 'test' AND riders.Level = 'Open' GROUP BY classes.EntryID HAVING COUNT(classes.TestID) > 2 ORDER BY AVG(TestScores.PercentageScore) DESC LIMIT 2";
...
//Introductory Level Amateur Results
		$intro_entries_sql = "SELECT entries.ID, riders.ID, classes.ID, tests.ID 
				FROM ( ( entries INNER JOIN riders ON riders.ID = entries.RiderID ) 
				INNER JOIN classes ON classes.EntryID = entries.ID ) INNER JOIN tests 
				ON tests.ID = classes.TestID WHERE tests.ID IN (1, 2, 3) AND entries.ShowID = 4 AND riders.Level = 'Amateur'";
		$intro_entries_res = mysqli_query( $mysqli, $intro_entries_sql ) or die(mysqli_error( $mysqli ) );
...
//Introductory Level junior Results
		$intro_entries_sql = "SELECT entries.ID, riders.ID, classes.ID, tests.ID 
				FROM ( ( entries INNER JOIN riders ON riders.ID = entries.RiderID ) 
				INNER JOIN classes ON classes.EntryID = entries.ID ) INNER JOIN tests 
				ON tests.ID = classes.TestID WHERE tests.ID IN (1, 2, 3) AND entries.ShowID = 4 AND riders.Level = 'Junior'";
		$intro_entries_res = mysqli_query( $mysqli, $intro_entries_sql ) or die(mysqli_error( $mysqli ) );
...
//Beginner Novice Senior Results
		$bneventing_entries_sql = "SELECT entries.ID, riders.ID, classes.ID, tests.ID 
				FROM ( ( entries INNER JOIN riders ON riders.ID = entries.RiderID ) 
				INNER JOIN classes ON classes.EntryID = entries.ID ) INNER JOIN tests 
				ON tests.ID = classes.TestID WHERE tests.ID IN (19, 20) AND entries.ShowID = 4 AND riders.Level IN ('Open', 'Amateur')";
...
//Beginner Novice Test A Senior
		...
		$senior_bneventing_sql = "SELECT riders.FirstName, riders.LastName, horses.Name, TestScores.PercentageScore 
							FROM ( ( ( entries INNER JOIN riders ON entries.riderID = riders.ID ) 
							INNER JOIN horses ON entries.HorseID = horses.ID ) INNER JOIN classes on entries.ID = classes.EntryID ) 
							INNER JOIN TestScores ON classes.ID = TestScores.ClassID WHERE entries.ShowID = 4 AND classes.TestID = 19
...
//Beginner Novice Test B Senior
		$senior_bneventing_sql = "SELECT riders.FirstName, riders.LastName, horses.Name, TestScores.PercentageScore 
							FROM ( ( ( entries INNER JOIN riders ON entries.riderID = riders.ID ) 
							INNER JOIN horses ON entries.HorseID = horses.ID ) INNER JOIN classes on entries.ID = classes.EntryID ) 
							INNER JOIN TestScores ON classes.ID = TestScores.ClassID WHERE entries.ShowID = 4 AND classes.TestID = 20 
							AND riders.Level IN ('Open', 'Amateur') ORDER BY TestScores.PercentageScore DESC";
		$senior_bneventing_res = mysqli_query( $mysqli, $senior_bneventing_sql ) or die(mysqli_error( $mysqli ) );
...
//Beginner Novice junior Results
		$bneventing_entries_sql = "SELECT entries.ID, riders.ID, classes.ID, tests.ID 
				FROM ( ( entries INNER JOIN riders ON riders.ID = entries.RiderID ) 
				INNER JOIN classes ON classes.EntryID = entries.ID ) INNER JOIN tests 
				ON tests.ID = classes.TestID WHERE tests.ID IN (19, 20) AND entries.ShowID = 4 AND riders.Level = 'Junior'
...
//Beginner Novice B Junior
		...
		$novice_entries_sql = "SELECT entries.ID, riders.ID, classes.ID, tests.ID 
				FROM ( ( entries INNER JOIN riders ON riders.ID = entries.RiderID ) 
				INNER JOIN classes ON classes.EntryID = entries.ID ) INNER JOIN tests 
				ON tests.ID = classes.TestID WHERE tests.ID IN (21, 22) AND entries.ShowID = 4 AND riders.Level IN ('Open', 'Amateur')";
	...
	<table id="table-wrap" style="width:100%;" border="1">
		...
		$senior_novice_sql = "SELECT riders.FirstName, riders.LastName, horses.Name, TestScores.PercentageScore 
							FROM ( ( ( entries INNER JOIN riders ON entries.riderID = riders.ID ) 
							INNER JOIN horses ON entries.HorseID = horses.ID ) INNER JOIN classes on entries.ID = classes.EntryID ) 
							INNER JOIN TestScores ON classes.ID = TestScores.ClassID WHERE entries.ShowID = 4 AND classes.TestID = 21 
							AND riders.Level IN ('Open', 'Amateur') ORDER BY TestScores.PercentageScore DESC";
		...
		$senior_novice_sql = "SELECT riders.FirstName, riders.LastName, horses.Name, TestScores.PercentageScore 
							FROM ( ( ( entries INNER JOIN riders ON entries.riderID = riders.ID ) 
							INNER JOIN horses ON entries.HorseID = horses.ID ) INNER JOIN classes on entries.ID = classes.EntryID ) 
							INNER JOIN TestScores ON classes.ID = TestScores.ClassID WHERE entries.ShowID = 4 AND classes.TestID = 22 
							AND riders.Level IN ('Open', 'Amateur') ORDER BY TestScores.PercentageScore DESC";
		$senior_novice_res = mysqli_query( $mysqli, $senior_novice_sql ) or die(mysqli_error( $mysqli ) );
...
<?php
		...
		$novice_entries_sql = "SELECT entries.ID, riders.ID, classes.ID, tests.ID 
				FROM ( ( entries INNER JOIN riders ON riders.ID = entries.RiderID ) 
				INNER JOIN classes ON classes.EntryID = entries.ID ) INNER JOIN tests 
				ON tests.ID = classes.TestID WHERE tests.ID IN (21, 22) AND entries.ShowID = 4 AND riders.Level = 'Junior'";
		$novice_entries_res = mysqli_query( $mysqli, $novice_entries_sql ) or die(mysqli_error( $mysqli ) );
...
<?php
		...
		$training_entries_sql = "SELECT entries.ID, riders.ID, classes.ID, tests.ID 
				FROM ( ( entries INNER JOIN riders ON riders.ID = entries.RiderID ) 
				INNER JOIN classes ON classes.EntryID = entries.ID ) INNER JOIN tests 
				ON tests.ID = classes.TestID WHERE tests.ID IN (23, 24) AND entries.ShowID = 4 AND riders.Level IN ('Open', 'Amateur')";
		$training_entries_res = mysqli_query( $mysqli, $training_entries_sql ) or die(mysqli_error( $mysqli ) );
	...
	<table id="table-wrap" style="width:100%;" border="1">
		...
		$senior_training_sql = "SELECT riders.FirstName, riders.LastName, horses.Name, TestScores.PercentageScore 
							FROM ( ( ( entries INNER JOIN riders ON entries.riderID = riders.ID ) 
							INNER JOIN horses ON entries.HorseID = horses.ID ) INNER JOIN classes on entries.ID = classes.EntryID ) 
							INNER JOIN TestScores ON classes.ID = TestScores.ClassID WHERE entries.ShowID = 4 AND classes.TestID = 23 
							AND riders.Level IN ('Open', 'Amateur') ORDER BY TestScores.PercentageScore DESC";
		...
		$senior_training_sql = "SELECT riders.FirstName, riders.LastName, horses.Name, TestScores.PercentageScore 
							FROM ( ( ( entries INNER JOIN riders ON entries.riderID = riders.ID ) 
							INNER JOIN horses ON entries.HorseID = horses.ID ) INNER JOIN classes on entries.ID = classes.EntryID ) 
							INNER JOIN TestScores ON classes.ID = TestScores.ClassID WHERE entries.ShowID = 4 AND classes.TestID = 24 
							AND riders.Level IN ('Open', 'Amateur') ORDER BY TestScores.PercentageScore DESC";
		$senior_training_res = mysqli_query( $mysqli, $senior_training_sql ) or die(mysqli_error( $mysqli ) );
...
<?php
		...
		$training_entries_sql = "SELECT entries.ID, riders.ID, classes.ID, tests.ID 
				FROM ( ( entries INNER JOIN riders ON riders.ID = entries.RiderID ) 
				INNER JOIN classes ON classes.EntryID = entries.ID ) INNER JOIN tests 
				ON tests.ID = classes.TestID WHERE tests.ID IN (23, 24) AND entries.ShowID = 4 AND riders.Level = 'Junior'";
		$training_entries_res = mysqli_query( $mysqli, $training_entries_sql ) or die(mysqli_error( $mysqli ) );
...
<?php
		...
		$prelim_entries_sql = "SELECT entries.ID, riders.ID, classes.ID, tests.ID 
				FROM ( ( entries INNER JOIN riders ON riders.ID = entries.RiderID ) 
				INNER JOIN classes ON classes.EntryID = entries.ID ) INNER JOIN tests 
				ON tests.ID = classes.TestID WHERE tests.ID IN (25, 26) AND entries.ShowID = 4 AND riders.Level IN ('Open', 'Amateur')";
	...
	<table id="table-wrap" style="width:100%;" border="1">
		...
		$senior_prelim_sql = "SELECT riders.FirstName, riders.LastName, horses.Name, TestScores.PercentageScore 
							FROM ( ( ( entries INNER JOIN riders ON entries.riderID = riders.ID ) 
							INNER JOIN horses ON entries.HorseID = horses.ID ) INNER JOIN classes on entries.ID = classes.EntryID ) 
							INNER JOIN TestScores ON classes.ID = TestScores.ClassID WHERE entries.ShowID = 4 AND classes.TestID = 25 
							AND riders.Level IN ('Open', 'Amateur') ORDER BY TestScores.PercentageScore DESC";
		...
		$senior_prelim_sql = "SELECT riders.FirstName, riders.LastName, horses.Name, TestScores.PercentageScore 
							FROM ( ( ( entries INNER JOIN riders ON entries.riderID = riders.ID ) 
							INNER JOIN horses ON entries.HorseID = horses.ID ) INNER JOIN classes on entries.ID = classes.EntryID ) 
							INNER JOIN TestScores ON classes.ID = TestScores.ClassID WHERE entries.ShowID = 4 AND classes.TestID = 26 
							AND riders.Level IN ('Open', 'Amateur') ORDER BY TestScores.PercentageScore DESC";
		$senior_prelim_res = mysqli_query( $mysqli, $senior_prelim_sql ) or die(mysqli_error( $mysqli ) );
...
<?php
		...
		$prelim_entries_sql = "SELECT entries.ID, riders.ID, classes.ID, tests.ID 
				FROM ( ( entries INNER JOIN riders ON riders.ID = entries.RiderID ) 
				INNER JOIN classes ON classes.EntryID = entries.ID ) INNER JOIN tests 
				ON tests.ID = classes.TestID WHERE tests.ID IN (25, 26) AND entries.ShowID = 4 AND riders.Level = 'Junior'";
		$prelim_entries_res = mysqli_query( $mysqli, $prelim_entries_sql ) or die(mysqli_error( $mysqli ) );
...
//Intermediate Senior Results
		$intermed_entries_sql = "SELECT entries.ID, riders.ID, classes.ID, tests.ID 
				FROM ( ( entries INNER JOIN riders ON riders.ID = entries.RiderID ) 
				INNER JOIN classes ON classes.EntryID = entries.ID ) INNER JOIN tests 
				ON tests.ID = classes.TestID WHERE tests.ID IN (27, 28) AND entries.ShowID = 4 AND riders.Level IN ('Open', 'Amateur')";
...
//Intermediate Test A Senior
		...
		$senior_intermed_sql = "SELECT riders.FirstName, riders.LastName, horses.Name, TestScores.PercentageScore 
							FROM ( ( ( entries INNER JOIN riders ON entries.riderID = riders.ID ) 
							INNER JOIN horses ON entries.HorseID = horses.ID ) INNER JOIN classes on entries.ID = classes.EntryID ) 
							INNER JOIN TestScores ON classes.ID = TestScores.ClassID WHERE entries.ShowID = 4 AND classes.TestID = 27
							AND riders.Level IN ('Open', 'Amateur') ORDER BY TestScores.PercentageScore DESC";
...
//Intermediate Test B Senior
		$senior_intermed_sql = "SELECT riders.FirstName, riders.LastName, horses.Name, TestScores.PercentageScore 
							FROM ( ( ( entries INNER JOIN riders ON entries.riderID = riders.ID ) 
							INNER JOIN horses ON entries.HorseID = horses.ID ) INNER JOIN classes on entries.ID = classes.EntryID ) 
							INNER JOIN TestScores ON classes.ID = TestScores.ClassID WHERE entries.ShowID = 4 AND classes.TestID = 28 
							AND riders.Level IN ('Open', 'Amateur') ORDER BY TestScores.PercentageScore DESC";
		$senior_intermed_res = mysqli_query( $mysqli, $senior_intermed_sql ) or die(mysqli_error( $mysqli ) );
...
//Intermediate junior Results
		$intermed_entries_sql = "SELECT entries.ID, riders.ID, classes.ID, tests.ID 
				FROM ( ( entries INNER JOIN riders ON riders.ID = entries.RiderID ) 
				INNER JOIN classes ON classes.EntryID = entries.ID ) INNER JOIN tests 
				ON tests.ID = classes.TestID WHERE tests.ID IN (27, 28) AND entries.ShowID = 4 AND riders.Level = 'Junior'";
		$intermed_entries_res = mysqli_query( $mysqli, $intermed_entries_sql ) or die(mysqli_error( $mysqli ) );
...
//Western Dressage Introductory Level Open Results
		$intro_entries_sql = "SELECT entries.ID, riders.ID, classes.ID, tests.ID 
				FROM ( ( entries INNER JOIN riders ON riders.ID = entries.RiderID ) 
				INNER JOIN classes ON classes.EntryID = entries.ID ) INNER JOIN tests 
				ON tests.ID = classes.TestID WHERE tests.ID IN (32, 33, 34, 35) AND entries.ShowID = 4 AND riders.Level = 'Open'";
		$intro_entries_res = mysqli_query( $mysqli, $intro_entries_sql ) or die(mysqli_error( $mysqli ) );
		...
		$open_intro_sql = "SELECT riders.FirstName, riders.LastName, horses.Name, TestScores.PercentageScore 
							FROM ( ( ( entries INNER JOIN riders ON entries.riderID = riders.ID ) 
							INNER JOIN horses ON entries.HorseID = horses.ID ) INNER JOIN classes on entries.ID = classes.EntryID ) 
							INNER JOIN TestScores ON classes.ID = TestScores.ClassID WHERE entries.ShowID = 4 AND classes.TestID = 32 
							AND riders.Level = 'Open' ORDER BY TestScores.PercentageScore DESC";
		$open_intro_res = mysqli_query( $mysqli, $open_intro_sql ) or die(mysqli_error( $mysqli ) );
		...
		$open_intro_sql = "SELECT riders.FirstName, riders.LastName, horses.Name, TestScores.PercentageScore 
							FROM ( ( ( entries INNER JOIN riders ON entries.riderID = riders.ID ) 
							INNER JOIN horses ON entries.HorseID = horses.ID ) INNER JOIN classes on entries.ID = classes.EntryID ) 
							INNER JOIN TestScores ON classes.ID = TestScores.ClassID WHERE entries.ShowID = 4 AND classes.TestID = 33 
							AND riders.Level = 'Open' ORDER BY TestScores.PercentageScore DESC";
		$open_intro_res = mysqli_query( $mysqli, $open_intro_sql ) or die(mysqli_error( $mysqli ) );
...
//Western Dressage Introductory Test 3 Open
		$open_intro_sql = "SELECT riders.FirstName, riders.LastName, horses.Name, TestScores.PercentageScore 
							FROM ( ( ( entries INNER JOIN riders ON entries.riderID = riders.ID ) 
							INNER JOIN horses ON entries.HorseID = horses.ID ) INNER JOIN classes on entries.ID = classes.EntryID ) 
							INNER JOIN TestScores ON classes.ID = TestScores.ClassID WHERE entries.ShowID = 4 AND classes.TestID = 34 
							AND riders.Level = 'Open' ORDER BY TestScores.PercentageScore DESC";
		$open_intro_res = mysqli_query( $mysqli, $open_intro_sql ) or die(mysqli_error( $mysqli ) );
...
//Western Dressage Introductory Test 4 Open
		$open_intro_sql = "SELECT riders.FirstName, riders.LastName, horses.Name, TestScores.PercentageScore 
							FROM ( ( ( entries INNER JOIN riders ON entries.riderID = riders.ID ) 
							INNER JOIN horses ON entries.HorseID = horses.ID ) INNER JOIN classes on entries.ID = classes.EntryID ) 
							INNER JOIN TestScores ON classes.ID = TestScores.ClassID WHERE entries.ShowID = 4 AND classes.TestID = 35 
							AND riders.Level = 'Open' ORDER BY TestScores.PercentageScore DESC";
		$open_intro_res = mysqli_query( $mysqli, $open_intro_sql ) or die(mysqli_error( $mysqli ) );
		...
		$intro_champs_sql = "SELECT classes.EntryID, riders.FirstName, riders.LastName, horses.Name, AVG(TestScores.PercentageScore) FROM ( ( ( entries INNER JOIN riders ON entries.riderID = riders.ID ) INNER JOIN horses ON entries.HorseID = horses.ID ) INNER JOIN classes on entries.ID = classes.EntryID ) INNER JOIN TestScores ON classes.ID = TestScores.ClassID WHERE classes.TestID = ANY ( SELECT ID from tests WHERE tests.ID IN (32, 33, 34, 35) ) AND entries.ShowID = 4 AND riders.FirstName <> 'test' AND riders.Level = 'Open' GROUP BY classes.EntryID HAVING COUNT(classes.TestID) > 2 ORDER BY AVG(TestScores.PercentageScore) DESC LIMIT 2";
		$intro_champs_res = mysqli_query( $mysqli, $intro_champs_sql ) or die(mysqli_error( $mysqli ) );
...
//Western Dressage Introductory Level Amateur Results
		$intro_entries_sql = "SELECT entries.ID, riders.ID, classes.ID, tests.ID 
				FROM ( ( entries INNER JOIN riders ON riders.ID = entries.RiderID ) 
				INNER JOIN classes ON classes.EntryID = entries.ID ) INNER JOIN tests 
				ON tests.ID = classes.TestID WHERE tests.ID IN (32, 33, 34, 35) AND entries.ShowID = 4 AND riders.Level = 'Amateur'";
		$intro_entries_res = mysqli_query( $mysqli, $intro_entries_sql ) or die(mysqli_error( $mysqli ) );
...
//Western Dressage Introductory Level junior Results
		$intro_entries_sql = "SELECT entries.ID, riders.ID, classes.ID, tests.ID 
				FROM ( ( entries INNER JOIN riders ON riders.ID = entries.RiderID ) 
				INNER JOIN classes ON classes.EntryID = entries.ID ) INNER JOIN tests 
				ON tests.ID = classes.TestID WHERE tests.ID IN (32, 33, 34, 35) AND entries.ShowID = 4 AND riders.Level = 'Junior'";
		$intro_entries_res = mysqli_query( $mysqli, $intro_entries_sql ) or die(mysqli_error( $mysqli ) );
...
//High Point Open
        ...
        WHERE entries.ShowID = 4 AND classes.TestID NOT IN (1, 2, 3, 32, 33, 34, 35) AND riders.FirstName <> 'test' AND riders.Member = 'Yes' 
...
//High Point Junior
		...
		FROM ( ( ( entries INNER JOIN riders ON entries.riderID = riders.ID ) 
			INNER JOIN horses ON entries.HorseID = horses.ID ) INNER JOIN classes on entries.ID = classes.EntryID ) 
            INNER JOIN TestScores ON classes.ID = TestScores.ClassID WHERE entries.ShowID = 4 AND classes.TestID NOT IN (1, 2, 3, 32, 33, 34, 35) 
